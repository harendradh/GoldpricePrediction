...
> **Auto-generated from `risk_assessment.py` · canonical spec for this skill**

Risk Assessment skill · computes change risk + probability/impact/detectability scores.
